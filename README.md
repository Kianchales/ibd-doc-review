...
对 Word 文档按招股书或审核问询反馈回复的样式规范进行排版：招股书版（000-009 样式）涵盖报告、备忘录、尽调报告等正式文档；反馈回复版（0011/001 体系）适用于审核问询回复与落实函回复。
...
当前版本 **v0.4.3**（frontmatter `version` 为准；版本演进见 `CHANGELOG.md`）。想固定某个版本使用时，checkout 对应 git tag 或下载对应 Release。
